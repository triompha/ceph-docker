...
ansible-playbook -vv -i $CEPH_ANSIBLE_SCENARIO_PATH/hosts $TOXINIDIR/ceph-ansible/site-docker.yml.sample --extra-vars="ceph_docker_username=$REGISTRY_ADDRESS/ceph fetch_directory=$CEPH_ANSIBLE_SCENARIO_PATH/fetch"
